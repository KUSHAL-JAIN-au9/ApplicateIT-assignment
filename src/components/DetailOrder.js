...
export default function DetailOrder({items}) {
      ...
      <Table className={classes.table} aria-label="customized table">
        <TableHead>
          <TableRow>
            ...
            <StyledTableCell align="center">{Orderkeys[0][5]}</StyledTableCell>
            <StyledTableCell align="center">{Orderkeys[0][6]}</StyledTableCell>
            <StyledTableCell align="center">{Orderkeys[0][1]}</StyledTableCell>
            <StyledTableCell align="center">{Orderkeys[0][2]}</StyledTableCell>
            <StyledTableCell align="center">{Orderkeys[0][7]}</StyledTableCell>
          </TableRow>
        </TableHead>
        <TableBody>
            {Order2?.map(k => {
                  ...
                  return <StyledTableRow key={k.id}>
                      <StyledTableCell align="center">{k.UserName}</StyledTableCell>
                        ...
                        <StyledTableCell align="center">{k.TotalProductCount}</StyledTableCell>
